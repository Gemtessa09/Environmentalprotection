...
const PoliciesIndex = () => {
  const items = [
    ...
    {
      title: "Biodiversity National Reports",
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 space-y-12">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 p-8 md:p-16 shadow-2xl transform-gpu">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="max-w-3xl text-lg md:text-xl leading-relaxed text-emerald-100 drop-shadow-lg mx-auto">
              Policy and strategy information that supports biodiversity conservation and sustainable development.
              Understanding the frameworks that guide environmental action.
            </p>
          </div>
        </div>
        ...
        <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 p-8 md:p-12 shadow-2xl hover:shadow-3xl transition-all duration-500 transform-gpu hover:scale-[1.01]">
          ...
          <div className="relative z-10 text-center">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h2 className="text-3xl font-black text-white drop-shadow-lg">Policy Framework</h2>
            </div>

            <p className="text-lg md:text-xl text-emerald-100 drop-shadow-lg max-w-4xl mx-auto leading-relaxed">
              Our policies section provides comprehensive information on the legal and strategic frameworks
              that guide biodiversity conservation and environmental sustainability in Ethiopia and globally.
            </p>
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <div className="flex items-center gap-2 px-6 py-3 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 text-white shadow-lg">
                ...
                <span className="font-semibold">National Strategies</span>
              </div>
              <div className="flex items-center gap-2 px-6 py-3 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 text-white shadow-lg">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="font-semibold">Legal Frameworks</span>
              </div>
              <div className="flex items-center gap-2 px-6 py-3 rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 text-white shadow-lg">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="font-semibold">Global Commitments</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center py-12">
          <div className="inline-block p-8 rounded-3xl bg-white/80 backdrop-blur-xl border border-emerald-200/50 shadow-2xl transform-gpu hover:scale-105 transition-all duration-500">
            <h3 className="text-2xl font-black text-emerald-950 mb-4">Explore Policy Frameworks</h3>
            <p className="text-slate-700 mb-6 max-w-2xl mx-auto">
              Dive deep into the policies and strategies that shape environmental conservation and sustainable development.
            </p>
